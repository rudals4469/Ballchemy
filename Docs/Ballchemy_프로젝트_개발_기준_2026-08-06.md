...
> 최종 갱신일: 2026-08-08
> 갱신 기준: 전투방 배치 패턴 5종, 첫 발사 위치 선택, 블록 스탯 편차, Guardian/Teleport/Gold 포함 통합 Special 풀과 조준·모서리 반사 보정 구현 시점
...
- 모든 패턴은 기본적으로 4행 이하일 때 실제 보드 행 간격 2를 적용해 3행은 0·2·4행, 4행은 0·2·4·6행에 배치하며 5행 이상은 연속 배치한다
...
- Zigzag Corridor는 맨 윗줄을 비우고 좌우 장벽과 반대편 입구가 완충 행을 사이에 두고 교대하며, 발사 지점 쪽 첫 입구는 중앙 열을 포함한다
- Center Gate는 중앙 3열 덩어리와 교대 어깨 블록, 중앙 1열 진입 끝을 사용해 좌우에 최소 2열 진입로를 유지한다
